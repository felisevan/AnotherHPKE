...
class AbstractKEM(ABC):
    ...
    def encap(self, pkR: PublicKeyTypes, skE: PrivateKeyTypes = None, pkE: PublicKeyTypes = None) -> tuple[
        bytes, bytes]:
        """
    ...
    def auth_encap(self, pkR: PublicKeyTypes, skS: PrivateKeyTypes, skE: PrivateKeyTypes = None,
                   pkE: PublicKeyTypes = None) -> tuple[
        bytes, bytes]:
        """
