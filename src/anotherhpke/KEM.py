...
from cryptography.hazmat.primitives.asymmetric.ec import generate_private_key, derive_private_key, SECP256R1, SECP384R1, \
    SECP521R1, EllipticCurvePublicKey, EllipticCurve, ECDH
...
class AbstractKEM(ABC):
    ...
    def encap(self, pkR: PublicKeyTypes, skE: PrivateKeyTypes = None, pkE: PublicKeyTypes = None) -> tuple[bytes, bytes]:
        """
    ...
    def auth_encap(self, pkR: PublicKeyTypes, skS: PrivateKeyTypes, skE: PrivateKeyTypes = None, pkE: PublicKeyTypes = None) -> tuple[
        bytes, bytes]:
        """
